...
namespace CyclicCodes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Введите информационное сообщение, длина которого равна 3-м символам: ");
            string message = Console.ReadLine();
            while (message.Length != 3)
            {
                Console.Write("Некорректный ввод. Введите любое сообщение с 3-мя символами: ");
                ...
                case 1:
                    {
                        ...
                        if (masXn[errorPosition] == 1) masXn[errorPosition] = 0;
                        else masXn[errorPosition] = 1;
                        Console.WriteLine();
                        break;
                    }
                case 2:
                    {
                        ...
                        if (masXn[errorPosition1] == 1) masXn[errorPosition1] = 0;
                        else masXn[errorPosition1] = 1;
                        if (masXn[errorPosition2] == 1) masXn[errorPosition2] = 0;
                        else masXn[errorPosition2] = 1;
                        Console.WriteLine();
                        break;
                    }
                default:
        ...
        public static int[] SearchError(int[] masXn, int[] masG, int[,] checkMatrix, int r)
        {
            int n = masXn.Length;
            int k = n - r;
        ...
        public static void OutMatrixProv(int[,] matrix, int k, int n)//////////////////////////////////
        {
            for (int i = 0; i < k; i++)
            {
                for (int j = 0; j < n; j++)
